...
def make_exe():
    ...
    # python_config.run_command = "import pylastic_exporter; pylastic_exporter"

    # Run a Python module as __main__ when the interpreter starts.
    python_config.run_module = "pylastic_exporter"
    ...
    #exe.add_python_resources(dist.pip_install(["src==2.0.0"]))
    ...
    exe.add_python_resources(exe.pip_install(["pylastic-exporter==2.0.15"]))
    ...
    for resource in exe.pip_download(["numpy==1.22.3",
                                      "pandas==1.4.2",
